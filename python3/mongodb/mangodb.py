...
#İKİNCİ VERİTABANI
client_iki=MongoClient("mongodb+srv://irmakkoc:7fGkHjIOqDJKiWXE@cluster0.z4sbgl0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db_iki=client_iki["test"]
collection=db_iki["parser"]
print("test database oluşturuldu:)")
print("parser koleksiyonu oluşturuldu:)")